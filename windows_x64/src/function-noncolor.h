...
void test()
{
    printf("\n[Success]: BioMatrix (v1.0.3) is running on your environment!\n");
}
...
void matrixScale(char *userInput)
{
    ...
    else
    {
        ...
        {
            printf("\n[Error]: Invalid_input\n");
            printf("\n[Help]: >> matrix.Scale(A,scale,result)\n");
        }
        fclose(fp);
    }
}
...
void matrixDet(char *userInput)
{
    ...
    if (check == 1)
    {
        ...
        if (check_former != 0 && (former.row == former.column))
        {
            ...
            printf("\n[Value]: Det(%s) has been saved.\n", former.name);
            printf("[ %g ]\n", result);
            printf("\n[System.Out]: Det(%s) is an value.\n", former.name);
            FILE *fvalue = NULL;
            fvalue = fopen("value", "a+");
            fprintf(fvalue, "\nDet(%s)<1,1>\n%g\n#\n", former.name, result);
            fclose(fvalue);
    ...
    if (token != 0 && check == 0 && cnt >= 1)
    {
        ...
        if (check_former != 0)
        {
            if (former.row == former.column)
            {
                ...
                {
                    printf("\n[Error]: Matrix Linearly_Dependent  <~ %s\n", former.name);
                }
            }
            else
            {
...
float vectorDot(char *userInput)
{
    ...
    else
    {
        ...
        {
            printf("\n[Error]: Invalid_input\n");
            printf("\n[Help]: >> vector.Dot(a,b,value.name)\n");
        }
        fclose(fp);
    }
...
void vectorCross(char *userInput)
{
    ...
    else
    {
        ...
        {
            printf("\n[Error]: Invalid_input \n");
            printf("\n[Help]: >> vector.Cross(a,b,vector.name) only in 3D.\n");
        }
        fclose(fp);
    }
}
...
double vectorAngle(char *userInput)
{
    ...
    else
    {
        ...
        {
            printf("\n[Error]: Invalid_input\n");
            printf("\n[Help]: >> vector.Angle(a,b,value.name).\n");
        }
    }
...
int valueDelete(char *userInput)
{
    ...
    if (fp != NULL)
    {
        ...
        if (strlen(matrixName) != 0)
        {
            ...
            if (check == 0)
            {
                printf("\n[Error]: Value Not_Found  <~ %s\n", matrixName);
            }
            else
            {
                printf("\n[Value]: %s has been deleted.\n", matrixName);
            }
        }
        else
        {
            printf("\n[Error]: Invalid_input\n");
            printf("\n[Help]: >> value.Del(value.name).\n");
        }
    }
    else
    {
